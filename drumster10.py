...
#drumster10.py - touchscreen drum machine for Tulip CC
# =====================================================================
# Install: copy this "drumster10" folder to /user, then:  run('drumster10.py')
#
#drumster10 is a 32 step Drum Machine for the Tulip Creative Computer. It uses the drum kits and
...
# =====================================================================
#
# PLAYBACK RELIABILITY CHANGES (drumster9 -> drumster10)
# ---------------------------------------------------------------------
